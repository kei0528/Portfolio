  ...
  const plot: PlotType[] = useMemo(
    () => [
      ...
      },
      {
        ...
        options: [
          { label: 'Yes', handler: () => router.push('/contents/me') },
      ...
      },
      {
        ...
        options: [
          { label: 'About', handler: () => router.push('/contents/me') },
          { label: 'Blog', handler: () => router.push('/contents/blog') },
          { label: 'Contact', handler: () => router.push('/contents/contact') },
